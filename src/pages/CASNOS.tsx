...
import { Users, ChevronLeft, Info } from 'lucide-react'
...
export default function CASNOS() {
  ...
  const fetchServices = async () => {
    try {
      const servicesData = await getServicesByCategory('CASNOS')
    ...
    <div className="min-h-screen">
      ...
      <section className="bg-gradient-to-b from-primary-50 to-white px-6 py-16 lg:px-12">
        <div className="container mx-auto text-center">
          <Users className="mx-auto mb-6 h-16 w-16 text-primary-500" />
          <h1 className="mb-4 text-h1 font-bold text-neutral-900">خدمات CASNOS - لغير الأجراء</h1>
          ...
          <div className="mb-8 flex items-start gap-4 rounded-lg bg-info-50 p-6">
            ...
            <div>
              ...
              <p className="text-body-small text-neutral-700">
                توجد حالات خاصة متعددة لشهادة عدم الانتساب: التجار، الحرفيون، أصحاب المهن الحرة، والفلاحون
              </p>
            </div>
          </div>
        </div>
